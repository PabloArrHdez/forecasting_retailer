...
df: ['fecha', 'producto_id', 'nombre', 'categoria', 'subcategoria',
       ...
       'semana_anio', 'trimestre', 'dia_anio', 'es_inicio_mes', 'es_fin_mes',
       'semana_año', 'dia_año', 'lag1', 'lag2', 'lag3', 'lag4', 'lag5', 'lag6',
       'lag7', 'media_movil_7d', 'descuento', 'precio_competencia',
       'ratio_precio', 'nombre_h_Adidas Ultraboost 23',
...
inferencia_df: ['fecha', 'producto_id', 'nombre', 'categoria', 'subcategoria',
       ...
       'dia_mes', 'dia_semana', 'nombre_dia', 'es_fin_semana', 'es_festivo',
       'es_black_friday', 'es_cyber_monday', 'semana_anio', 'trimestre',
       'dia_anio', 'es_inicio_mes', 'es_fin_mes', 'precio_competencia',
       'ratio_precio', 'descuento', 'lag1', 'lag2', 'lag3', 'lag4', 'lag5',
       'lag6', 'lag7', 'media_movil_7d', 'nombre_h_Adidas Ultraboost 23',
       'nombre_h_Asics Gel Nimbus 25', 'nombre_h_Bowflex SelectTech 552',
       'nombre_h_Columbia Silver Ridge',
       'nombre_h_Decathlon Bandas Elásticas Set', 'nombre_h_Domyos BM900',
       'nombre_h_Domyos Kit Mancuernas 20kg',
